    ...
    $.widget('custom.SwatchRenderer', {
        ...
        _RenderControls: function () {
            ...
            $.each(this.options.jsonConfig.attributes, function () {
                ...
                // Kong Custom
                var addStr = (item.label === "Size") ? '<div class="clickSizeChart"><span>* Size Chart</span></div><div class="clearfix"></div>': '';
                // # Kong Custom

                // Create new control
                container.append(
                    '<div class="' + classes.attributeClass + ' ' + item.code + '" attribute-code="' + item.code + '" attribute-id="' + item.id + '">' + label +
                    '<div class="' + classes.attributeOptionsWrapper + ' clearfix">' + options + select + '</div>' + addStr + input + '</div>'
                );
